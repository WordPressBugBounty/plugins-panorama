...
if ( function_exists( 'panorama_fs' ) ) {
            ...
            if ( !isset( $panorama_fs ) ) {
                ...
                $panorama_fs = fs_dynamic_init( array(
                    ...
                    'menu'           => array(
                        ...
                        'first-path' => 'edit.php?post_type=bppiv-image-viewer&page=bppiv-support#/dashboard',
                    ),
                    'is_live'        => true,
                ) );
            }
    ...
    define( 'BPPIV_VERSION', ( isset( $_SERVER['HTTP_HOST'] ) && $_SERVER['HTTP_HOST'] === 'localhost' ? time() : '1.3.3' ) );
